...
sizes = directory_sizes(file_structure)
size_to_remove = 30_000_000 - (70_000_000 - sizes.first)

smallest_size = sizes.reduce do |smallest, current_size|
  if current_size >= size_to_remove && current_size < smallest
    current_size
  else
    smallest
  end
